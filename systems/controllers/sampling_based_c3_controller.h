...
class SamplingC3Controller : public drake::systems::LeafSystem<double> {
 ...
 private:
  ...
  void UpdateContext_c3(Eigen::VectorXd lcs_state) const;
  ...
  drake::multibody::MultibodyPlant<double>& plant_c3_;
  drake::systems::Context<double>* context_c3_;
  drake::multibody::MultibodyPlant<drake::AutoDiffXd>& plant_ad_c3_;
  drake::systems::Context<drake::AutoDiffXd>* context_ad_c3_;
  const std::vector<std::vector<drake::SortedPair<drake::geometry::GeometryId>>>&
      contact_pairs_c3_;
