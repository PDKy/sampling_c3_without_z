...
struct SamplingC3Options {
  ...
  std::vector<double> u_x_without_z;
  ...
  std::vector<double> q_vector_without_z;
  ...
  std::vector<double> g_x_position_tracking_without_z;
  ...
  std::vector<double> u_x_position_tracking_without_z;
  ...
  Eigen::MatrixXd Q_position_without_z;
  Eigen::MatrixXd Q_position_and_orientation;
  Eigen::MatrixXd Q_position_and_orientation_without_z;
  Eigen::MatrixXd R;
  Eigen::MatrixXd R_without_z;
  Eigen::MatrixXd G;
  ...
  void Serialize(Archive* a) {
    ...
    a->Visit(DRAKE_NVP(q_vector_without_z));
    a->Visit(DRAKE_NVP(q_vector_position_and_orientation));
    a->Visit(DRAKE_NVP(q_vector_position_and_orientation_without_z));
    a->Visit(DRAKE_NVP(r_vector));
    a->Visit(DRAKE_NVP(r_vector_without_z));
    a->Visit(DRAKE_NVP(g_x));
    a->Visit(DRAKE_NVP(g_x_without_z));
    ...
    a->Visit(DRAKE_NVP(g_x_position_tracking_without_z));
    ...
    a->Visit(DRAKE_NVP(u_x_without_z));
    ...
    a->Visit(DRAKE_NVP(u_x_position_tracking_without_z));
    ...
    //TODO is this right?
    a->Visit(DRAKE_NVP(with_z));
    a->Visit(DRAKE_NVP(c3_height));
    ...
    if (with_z) {
      ...
      g_vector.insert(g_vector.end(), g_x_without_z.begin(), g_x_without_z.end());


      g_vector_for_curr_location = std::vector<double>();
      g_vector_for_curr_location.insert(g_vector_for_curr_location.end(), g_x_without_z.begin(), g_x_without_z.end());

      g_vector_position_tracking = std::vector<double>();
      g_vector_position_tracking.insert(g_vector_position_tracking.end(),
                                        g_x_position_tracking_without_z.begin(), g_x_position_tracking_without_z.end());
    ...
    if (with_z) {
      ...
      g_vector.insert(g_vector.end(), g_u_without_z.begin(), g_u_without_z.end());
      g_vector_for_curr_location.insert(g_vector_for_curr_location.end(), g_u_without_z.begin(), g_u_without_z.end());
      g_vector_position_tracking.insert(g_vector_position_tracking.end(), g_u_position_tracking_without_z.begin(), g_u_position_tracking_without_z.end());
      g_vector_position_tracking_for_curr_location.insert(g_vector_position_tracking_for_curr_location.end(), g_u_position_tracking_without_z.begin(), g_u_position_tracking_without_z.end());

      u_vector = std::vector<double>();
      u_vector.insert(u_vector.end(), u_x_without_z.begin(), u_x_without_z.end());

      u_vector_for_curr_location = std::vector<double>();
      u_vector_for_curr_location.insert(u_vector_for_curr_location.end(), u_x_without_z.begin(), u_x_without_z.end());

      u_vector_position_tracking = std::vector<double>();
      u_vector_position_tracking.insert(u_vector_position_tracking.end(), u_x_position_tracking_without_z.begin(), u_x_position_tracking_without_z.end());

      u_vector_position_tracking_for_curr_location = std::vector<double>();
      u_vector_position_tracking_for_curr_location.insert(u_vector_position_tracking_for_curr_location.end(), u_x_position_tracking_without_z.begin(), u_x_position_tracking_without_z.end());
    }
    ...
    if (with_z) {
      ...
      u_vector.insert(u_vector.end(), u_u_without_z.begin(), u_u_without_z.end());
      u_vector_for_curr_location.insert(u_vector_for_curr_location.end(), u_u_without_z.begin(), u_u_without_z.end());
      u_vector_position_tracking.insert(u_vector_position_tracking.end(), u_u_position_tracking_without_z.begin(), u_u_position_tracking_without_z.end());
      u_vector_position_tracking_for_curr_location.insert(u_vector_position_tracking_for_curr_location.end(), u_u_position_tracking_without_z.begin(), u_u_position_tracking_without_z.end());
    ...
    Eigen::VectorXd q_without_z = Eigen::Map<Eigen::VectorXd, Eigen::Unaligned>(
    this->q_vector_without_z.data(), this->q_vector_without_z.size());
    ...
    Eigen::VectorXd q_position_and_orientation_without_z = Eigen::Map<Eigen::VectorXd, Eigen::Unaligned>(
    this->q_vector_position_and_orientation_without_z.data(), this->q_vector_position_and_orientation_without_z.size());

    Eigen::VectorXd r = Eigen::Map<Eigen::VectorXd, Eigen::Unaligned>(
        this->r_vector.data(), this->r_vector.size());

    Eigen::VectorXd r_without_z = Eigen::Map<Eigen::VectorXd, Eigen::Unaligned>(
    this->r_vector_without_z.data(), this->r_vector_without_z.size());
    ...
    if (with_z) {
      ...
      Q_position = w_Q * q_without_z.asDiagonal();
      Q_position_and_orientation = w_Q * q_position_and_orientation_without_z.asDiagonal();
      R = w_R * r_without_z.asDiagonal();
      G = w_G * g.asDiagonal();
      G_for_curr_location = w_G * g_for_curr_location.asDiagonal();
      G_position_tracking = w_G_position_tracking * g_position_tracking.asDiagonal();
      G_position_tracking_for_curr_location = w_G_position_tracking * g_position_tracking_for_curr_location.asDiagonal();
